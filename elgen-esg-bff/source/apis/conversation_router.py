...
from fastapi import APIRouter, Body, Depends, Path, Security, Header
...
async def get_available_conversations_per_user(
    ...
    return await conversation_service.get_available_conversations_per_user(user_id=user_id, workspace_id=workspace_id)
