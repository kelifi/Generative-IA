...
from source.schemas.source_schemas import SourceInput, SourceOutput
...
class ConversationService:
    ...
    async def get_available_conversations_per_user(self, user_id: str, workspace_id: UUID) -> list[
    ...
    async def add_source_to_database(self, source: SourceInput) -> dict:
        return await make_request(
            service_url=self.config["CONVERSATION_SERVICE_URL"],
            uri="/sources",
            body=source.dict(),
