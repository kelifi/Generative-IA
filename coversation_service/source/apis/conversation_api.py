...
from source.exceptions.service_exceptions import ConversationValidationError, ConversationFetchDataError, \
    ...
    ModelServiceConnectionError, ChatModelDiscoveryError, ClassificationModelRetrievalError
...
async def create_question(question_input: QuestionInputSchema,
                          ...
                          skip_doc: bool = Query(...), skip_web: bool = Query(...),
                          conversation_service: ConversationService = Depends(
                              Provide[DependencyContainer.conversation_service])):
    """
    ...
    """
    try:
        return await conversation_service.create_question(question_input.question, conversation_id, skip_doc, skip_web)
